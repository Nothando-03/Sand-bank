...
namespace CyberSecurityAwarenessBotGUI.Services
{
    public class ChatbotService
    {
        ...
        {
            return "Hello. Welcome to the Cybersecurity Awareness Bot. Please enter your name by typing: my name is yourname";
        }
        ...
        public string ProcessInput(string input)
        {
            ...
            if (lowerInput.StartsWith("my name is"))
            {
                ...
                _memoryService.RememberName(name);
            ...
            if (lowerInput.Contains("i am interested in") || lowerInput.Contains("i'm interested in"))
            {
                ...
                _memoryService.RememberFavouriteTopic(topic);
            ...
            {
                string favourite = _memoryService.GetFavouriteTopic();
            ...
            if (lowerInput.Contains("another tip") || lowerInput.Contains("tell me more") || lowerInput.Contains("explain more"))
            {
